...
![NoisyNosesWeb screenshot](img/screenshot.png)
...
An older prototype of the `NoisyNosesWeb` software is available as [NoisyNoses](https://github.com/samkirkham/NoisyNoses)
...
```
And then open http://localhost:8000  in a browser, select your stereo audio device, and click **Start**.

Alternatively, you can use `npx` if you have Node.js installed:
